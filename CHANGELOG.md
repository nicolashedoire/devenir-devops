...
- GitOps : environnements locaux de recette et de production gérés par Argo CD ; distinction entre synchronisation déclarative et réussite de la livraison.
- Observabilité : OpenTelemetry, Prometheus, Grafana, Loki et Tempo ; scénarios normal, lent et en erreur, parentage HTTP→SQL, journaux corrélés et alertes.
...
Les validations publiées comprennent [six contrôles Kubernetes](https://github.com/nicolashedoire/devenir-devops/actions/runs/36006794074), [l’observabilité](https://github.com/nicolashedoire/devenir-devops/actions/runs/36009589062) et [les opérations et la recette](https://github.com/nicolashedoire/devenir-devops/actions/runs/36009530009). Le [registre](docs/validation.md) et les registres spécialisés précisent les commits, les environnements et les limites de chaque essai ; les résultats d’un workflow ne valent pas validation de toute installation possible.
